...
CXX=g++
CXXFLAGS=-std=c++11 -I./include -O2 -g -G -Xcompiler -Wall -lm -pg

NVCC=nvcc
ARCH=sm_75
NVCCFLAGS=-I./include -arch=$(ARCH) -std=c++11 -O2 -g -G -Xcompiler -Wall --compiler-bindir=$(CXX) -lm -pg -lnvToolsExt
